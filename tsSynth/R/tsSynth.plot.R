...
#' @examples
#'   ##In order to run tsSynth.test() properly, we recommend users to run
...
#'   tsSynth.meth.out = tsSynth.meth(tsSynth.prep.out)
#'
...
tsSynth.plot = function(synth.meth.obj = NULL, type = "path", tr.intake = NULL, Ylab = "Outcome",
